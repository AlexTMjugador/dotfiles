...
# - We do, to allow cloning plugins as submodules of a top dotfiles repository,
#   alongside Oh My Zsh itself
...
# Include misc user bin directories
...
# Set up SSH auth agent socket address to the sanest default
